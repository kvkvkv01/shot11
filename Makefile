...
SRCS	= src/main.c src/app.c src/app_save.c src/capture.c \
		src/capture_bgra.c \
		src/capture_utils.c src/capture_shift.c src/capture_round.c \
		src/shadow.c src/shadow_calc.c \
	...
	src/png_wic_write.c src/path.c src/magick.c src/render.c src/tray.c \
	src/util.c \
