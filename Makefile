...
SRCS	= src/main.c src/app.c src/capture.c src/capture_bgra.c \
		...
		src/clipboard.c src/png.c src/png_wic_open.c src/png_wic_write.c \
		src/path.c src/util.c src/util_mem.c src/util_str.c src/util_time.c \
		src/util_log.c
OBJS	= $(SRCS:.c=.o)
